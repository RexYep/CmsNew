    ...
    <div class="card-body">
        <div class="row g-3">
            <?php while ($attachment = $attachments->fetch_assoc()):
                ...
                $file_size     = round($attachment['file_size'] / 1024 / 1024, 2);

                // Smart URL: use cloudinary_url if available, else file_path
                $stored_url    = !empty($attachment['cloudinary_url'])
                                    ? $attachment['cloudinary_url']
                                    : $attachment['file_path'];

                // Get proper displayable URL (handles both local and Cloudinary)
                $display_url   = getFileUrl($stored_url);
                $is_cloudinary = isCloudinaryUrl($stored_url);
                $resource_type = $attachment['cloudinary_resource_type'] ?? 'auto';
                ...
                <div class="card h-100">
                    <div class="card-body p-2">
                        ...
                        <div class="text-center mb-2"
                             style="min-height:150px; display:flex; align-items:center;
                            ...
                            <?php elseif ($is_video): ?>
                                <video controls class="w-100 rounded" style="max-height:150px;">
                                    <source src="<?php echo htmlspecialchars($display_url); ?>"
                                            type="<?php echo htmlspecialchars($file_type); ?>">
                            ...
                            <?php elseif ($is_pdf): ?>
                                <a href="<?php echo htmlspecialchars($display_url); ?>"
                                   target="_blank" class="text-decoration-none">
                                    ...
                                    <div class="mt-2 text-muted small">Click to view PDF</div>
                                </a>
                            ...
                            <?php else: ?>
                                <a href="<?php echo htmlspecialchars($display_url); ?>"
                                   target="_blank" class="text-decoration-none">
                                    ...
                                    <div class="mt-2 text-muted small">Click to download</div>
                                </a>
                            <?php endif; ?>
                            ...
                            <span class="badge position-absolute top-0 end-0 m-2"
                                  ...
                                  title="<?php echo $is_cloudinary ? 'Stored in Cloudinary' : 'Stored locally'; ?>">
                        ...
                        <div class="text-center">
                            <div class="text-truncate small fw-bold"
                                 title="<?php echo htmlspecialchars($file_name); ?>">
                                <?php echo htmlspecialchars($file_name); ?>
                            </div>
                            <div class="text-muted" style="font-size:0.75rem;">
                                <?php echo $file_size; ?> MB
                            </div>
                            <a href="<?php echo htmlspecialchars($display_url); ?>"
                               download
...
<div class="alert alert-info mt-3">
    <i class="bi bi-info-circle"></i> No attachments for this complaint.
</div>
<?php endif; ?>
                <div class="mb-3">
