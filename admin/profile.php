    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header bg-light">
                <i class="bi bi-person-badge"></i> Admin Summary
            </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-2">
                    <span>Pending:</span>
                    <strong class="text-warning"><?php echo $pending_complaints; ?></strong>
                </div>
                <div class="d-flex justify-content-between">
                    <span>Resolved:</span>
                    <strong class="text-success"><?php echo $resolved_complaints; ?></strong>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <?php if ($has_avatar): ?>
                        <a href="?delete_picture=1" class="btn btn-danger me-auto"
